...
const strandPaths = [...markSvgSource.matchAll(/d="([^"]+)"/g)].map((m) => m[1]);
...
<svg xmlns="http://www.w3.org/2000/svg" width="${entrySize}" height="${entrySize}" viewBox="0 0 64 64" fill="none">
  ...
  <g transform="translate(8.96 8.96) scale(0.72)" fill="none" stroke="#A9BED3" stroke-width="3" stroke-linecap="round">
