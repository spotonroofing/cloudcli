...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        // Ramped entrances (ui13 job 7): the vendored beUI EASE_OUT, never
        // the weak default ease-out.
        shimmer: 'shimmer 2s linear infinite',
        'dialog-overlay-show': 'dialog-overlay-show 180ms cubic-bezier(0.16, 1, 0.3, 1)',
