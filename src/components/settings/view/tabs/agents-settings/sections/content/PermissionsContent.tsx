    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-primary/30 bg-primary/10 p-4">
        ...
        <ul className="space-y-1 text-sm text-foreground">
          <li><code className="rounded bg-primary/10 px-1">"Bash(git log:*)"</code> {t('permissions.toolExamples.bashGitLog')}</li>
          <li><code className="rounded bg-primary/10 px-1">"Bash(git diff:*)"</code> {t('permissions.toolExamples.bashGitDiff')}</li>
          <li><code className="rounded bg-primary/10 px-1">"Write"</code> {t('permissions.toolExamples.write')}</li>
          <li><code className="rounded bg-primary/10 px-1">"Bash(rm:*)"</code> {t('permissions.toolExamples.bashRm')}</li>
        </ul>
      </div>
