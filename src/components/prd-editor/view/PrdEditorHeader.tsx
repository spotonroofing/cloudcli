    ...
    <div className="flex min-w-0 flex-shrink-0 items-center justify-between border-b border-border p-4">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex min-w-0 flex-col gap-2 sm:flex-row sm:items-center">
            <div className="flex min-w-0 flex-1 items-center gap-1">
              <div className="flex min-w-0 flex-1 items-center rounded-md border border-border bg-muted px-3 py-2 focus-within:border-ring focus-within:ring-2 focus-within:ring-ring">
                <input
                  ref={fileNameInputRef}
                  type="text"
                  value={fileName}
                  onChange={(event) => onFileNameChange(event.target.value)}
                  className="min-w-0 flex-1 border-none bg-transparent text-base font-medium text-foreground placeholder:text-muted-foreground outline-none md:text-sm"
      ...
      <div className="flex flex-shrink-0 items-center gap-1 md:gap-2">
        ...
        <button
          ...
          className={cn(
            'px-3 py-2 rounded-md disabled:opacity-50 flex items-center gap-2 transition-colors text-sm font-medium min-h-[44px] md:min-h-0',
        ...
        <button
          ...
          disabled={saving}
          className={cn(
            'px-3 py-2 rounded-md disabled:opacity-50 flex items-center gap-2 transition-colors min-h-[44px] md:min-h-0',
            saveSuccess ? 'bg-green-600 hover:bg-green-700 text-white' : 'bg-primary hover:bg-primary/90 text-primary-foreground',
          )}
        >
          {saveSuccess ? (
            <>
        ...
        <button
          ...
          className="hidden items-center justify-center rounded-md p-2 text-muted-foreground hover:bg-accent hover:text-foreground md:flex"
