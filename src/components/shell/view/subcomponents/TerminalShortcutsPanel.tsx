...
const KEY_BTN =
  'touch-hit relative shrink-0 rounded-md border border-gray-600 bg-gray-700 px-2.5 py-1.5 text-xs font-medium text-gray-100 transition-colors select-none active:bg-primary active:text-primary-foreground active:border-primary disabled:cursor-not-allowed disabled:opacity-40';
const KEY_BTN_ACTIVE =
  'touch-hit relative shrink-0 rounded-md border border-primary bg-primary px-2.5 py-1.5 text-xs font-medium text-primary-foreground transition-colors select-none disabled:cursor-not-allowed disabled:opacity-40';
const ICON_BTN =
  'touch-hit relative shrink-0 rounded-md border border-gray-600 bg-gray-700 p-1.5 text-gray-100 transition-colors select-none active:bg-primary active:text-primary-foreground active:border-primary disabled:cursor-not-allowed disabled:opacity-40';
...
export default function TerminalShortcutsPanel({
  ...
  return (
    <div className={`pointer-events-none fixed inset-x-0 ${bottomOffset} z-20 px-2 pb-[env(safe-area-inset-bottom)] md:hidden`}>
      <div className="pointer-events-auto flex items-center gap-1 overflow-x-auto rounded-lg border border-gray-700/80 bg-gray-900/95 px-1.5 py-1.5 shadow-lg backdrop-blur-sm scrollbar-hide">
        <button
          type="button"
