      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div className="relative max-w-md flex-1">
          ...
          <input
            ...
            className="w-full rounded-lg border border-border bg-card py-2 pl-10 pr-4 text-foreground"
          />
        </div>
                ...
                {existingPrds.length > 0 ? (
                  <>
                    ...
                    >
                      ...
                      <span className="min-w-5 rounded-md bg-primary-foreground/20 text-primary-foreground px-1.5 py-0.5 text-center text-xs">
                        {existingPrds.length}
                      </span>
                      ...
                      <div className="popout-enter absolute right-0 top-full z-30 mt-2 w-56 rounded-lg border border-border bg-popover shadow-lg">
                        <div className="p-2">
                          <button
                            ...
                            className="flex w-full items-center gap-2 rounded px-3 py-2 text-left text-sm font-medium text-foreground hover:bg-accent"
                          >
