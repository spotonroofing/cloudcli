...
function getPriorityBadgeClass(priority?: string): string {
  ...
  if (priority === 'low') return 'text-muted-foreground bg-muted';
          ...
          <div className="flex min-w-0 flex-1 items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <button
                ...
                className="mb-2 inline-flex items-center gap-1 rounded bg-muted px-2 py-1 text-xs text-muted-foreground hover:bg-accent"
                title="Copy task ID"
              >
              ...
              {isEditMode ? (
                <input
                  ...
                  className="w-full border-b-2 border-ring bg-transparent text-lg font-semibold text-foreground focus:outline-none"
                />
              ) : (
        ...
        <div className="flex-1 space-y-6 overflow-y-auto p-4 md:p-6">
                ...
                <div className="flex flex-wrap gap-1">
                  {task.dependencies.map((dependency) => (
                    <button
                      ...
                      className="rounded border border-primary/30 bg-primary/10 px-2 py-1 text-sm text-primary hover:bg-primary/20"
                    >
          ...
          <div className="space-y-2">
            ...
            {isEditMode ? (
              ...
              <p className="whitespace-pre-wrap text-foreground">{task.description || 'No description provided'}</p>
            )}
          </div>
            ...
            <div className="rounded-lg border border-border">
              ...
              {showDetails && (
                <div className="border-t border-border p-4">
                  <p className="whitespace-pre-wrap text-foreground">{task.details}</p>
                </div>
              )}
            </div>
          )}
            ...
            <div className="rounded-lg border border-border">
              ...
              {showTestStrategy && (
                <div className="border-t border-border bg-muted/30 p-4">
                  <p className="whitespace-pre-wrap text-foreground">{task.testStrategy}</p>
                </div>
              )}
            </div>
          )}
