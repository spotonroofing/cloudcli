  ...
  return (
    <div>
      <div className="mb-1.5 flex items-center gap-2">
        ...
        <div className="h-1 flex-1 overflow-hidden rounded-sm bg-gray-200 dark:bg-gray-700">
          <div
            className="h-full rounded-sm bg-green-500 transition-all dark:bg-green-400"
