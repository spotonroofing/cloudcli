...
export function ComposerMenuSurface({
  ...
  return (
    <div
      ...
      className="popout-enter popout-enter-up fixed z-[100] min-w-48 overflow-y-auto overscroll-contain rounded-lg border border-border bg-popover p-1 text-popover-foreground shadow-lg"
      style={{
        right: anchor.right,
