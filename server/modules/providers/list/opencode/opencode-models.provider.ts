...
export const OPENCODE_PREDEFINED_MODELS: ProviderModelsDefinition = {
  OPTIONS: [
    ...
    { value: 'opencode/claude-fable-5-1', label: 'Claude Fable 5.1', description: 'OpenCode Zen' },
    ...
    { value: 'anthropic/claude-fable-5-1', label: 'Claude Fable 5.1', description: 'Anthropic' },
