...
Narrate as you go: before each step or batch of tool calls, write one short plain line saying what you are about to do and why, and one line with the result when it lands; this running feed is what Willem watches in the worker pane, and silence between tool calls reads as a stall. Group related shell work into one call rather than many small ones, and read files with the Read tool in the ranges you need.
