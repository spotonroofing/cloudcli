...
<!-- tasks: Less indent, wider sidebar, tooltip | Ring check and red X for done and failed | Per-task durations and live counters | Verify row as a task, only when live | Mono text, red failures with reason | Month and year grouping -->
