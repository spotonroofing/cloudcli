...
<!-- model: gpt-5.6-sol -->
<!-- effort: xhigh -->
<!-- supersedes: ui15r2/6, ui15r/5, ui15/7 -->
<!-- name: Usage alerts -->
<!-- tasks: Gated 5h alerts per account | Parking never disables accounts | Near-real-time usage in the switcher | All-dry turns auto-retry at reset | Fleet-wide window aggregates | Thresholds cover ChatGPT too -->
