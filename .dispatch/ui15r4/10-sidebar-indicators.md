...
<!-- tasks: Row shifts as one, title gains width | Quiet planner and worker indicators | Beam distinguishes planner vs worker | Verify spinner in the ring center | Account drawer stays open | Switcher: Claude header, one anatomy | One footer button, sectioned drawer -->
