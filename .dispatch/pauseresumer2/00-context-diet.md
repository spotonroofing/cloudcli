...
<!-- model: gpt-5.6-sol -->
<!-- effort: high -->
<!-- supersedes: ui15r2/1, pauseresume/3, pauseresumer/1 -->
<!-- name: Context diet -->
<!-- tasks: No MCP in headless and machine sessions | Recovery notices stop waking the planner | Worker stop square pauses the chain | Jobs column state persists | Effort switcher proven real -->
