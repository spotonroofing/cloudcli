...
- [ ] The watchdog chain record's phase total updates when appends are announced, so wake and event messages read "phase 11 of 14", never "phase 11 of 8" (the ui11 failure wake carried the stale dispatch-time total).
